...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../../.node/lib/node_modules/parcel/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"../../../.node/lib/node_modules/parcel/node_modules/process/browser.js"}],"js/import-jquery.js":[function(require,module,exports) {
"use strict";
...
},{"jquery":"node_modules/jquery/dist/jquery.js"}],"node_modules/headroom.js/dist/headroom.js":[function(require,module,exports) {
var define;
var global = arguments[3];
/*!
...
var theNav = document.querySelector("nav"); // construct an instance of Headroom, passing the element

var headroom = new _headroom.default(theNav); // initialise

headroom.init();
var mobileMenu = $("#nav-mobile-normal");
var mobileMenuItems = $("ul.nav-items");
var linkItem = $(".nav-item a");
mobileMenu.click(function () {
  mobileMenuItems.toggleClass("show-menu");
  $(".mobile-init").toggleClass("lock-body");
  $(".nav-normal").toggleClass("bg-primary");
  $("#nav-icon2").toggleClass('open');
});
linkItem.click(function () {
  mobileMenuItems.removeClass("show-menu");
  $(".mobile-init").removeClass("lock-body");
  $(".nav-normal").removeClass("bg-primary");
  $("#nav-icon2").removeClass('open');
});
var mobileMenuCompany = $("#nav-mobile-company");
var mobileMenuCompanyItems = $("ul.nav-items");
var linkItemCompany = $(".nav-item a");
mobileMenuCompany.click(function () {
  mobileMenuCompanyItems.toggleClass("show-menu");
  $(".mobile-init").toggleClass("lock-body");
  $(".nav-invert").toggleClass("bg-white");
  $("#nav-icon2").toggleClass('open');
});
linkItemCompany.click(function () {
  mobileMenuCompanyItems.removeClass("show-menu");
  $(".mobile-init").removeClass("lock-body");
  $(".nav-invert").removeClass("bg-white");
  $("#nav-icon2").removeClass('open');
});
...
var marker = L.marker([-6.188366, 106.814125], {
  icon: mkrMarker
}).addTo(mymap);
...
}).addTo(mymap); // https://api.mapbox.com/styles/v1/rizalondev/ck2qii238058b1cmsjhx359op/tiles/256/{z}/{x}/{y}@2x?access_token=pk.eyJ1Ijoicml6YWxvbmRldiIsImEiOiJjano0NzJvMjcwMDhlM2NwMGdqNDNmcGJ0In0.GSZg6WD5afsnHQGoPENsbw
...
},{"./import-jquery":"js/import-jquery.js","headroom.js":"node_modules/headroom.js/dist/headroom.js"}],"../../../.node/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../.node/lib/node_modules/parcel/src/builtins/hmr-runtime.js","js/index.js"], null)
